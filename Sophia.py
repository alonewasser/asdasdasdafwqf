    ...
    if event.type ==VkEventType.MESSAGE_NEW:
     ...
     if event.from_user and not (event.from_me):
         if response == 'привет':
             ...
             send_message(peer_id=event.peer_id,
                          message='Я занята, напиши на другую страницу, если у тебя действительно что-то ВАЖНОЕ! https://vk.com/jannyandmarjo')
             ...
             send_message(peer_id=event.peer_id,
                          message='https://img1.wlresources.com/photo/2544841/gallery/NicolsQueenSeks-Cam-Canl-Gosteri-66-151066.jpg')
         elif response == 'ня':
             send_message(peer_id=event.peer_id,
